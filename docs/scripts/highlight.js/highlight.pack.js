...
hljs.registerLanguage("infinityscript", function(e) {
    var r = "[A-Za-z$_][0-9A-Za-z$_]*",
        t = {
            keyword: "typespace type define if for else var $this static partial",
    ...
    return {
        ...
        c: [{
            ...
            cN: "(type|typespace|class|enum|struct|interface)",
            bK: "type typespace class enum struct interface",
            e: /[{;=]/,
            eE: !0,
            i: /[:"\[\]]/,
            c: [{
